...
attorneyPhone=attorneyPhone[:20]
...
#all_p=all_div.find_all('p')
print ('----------------------------------------')
pwsource='';educationmin='';trainingreq='';altedu='';alienEducation='';
for row in all_li:
	i+=1
	#print (i,'...',str(row))
